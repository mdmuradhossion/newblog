        ...
        <div class="container">
            <div class="owl-carousel owl-theme blog-slider">
                <div class="card blog__slide text-center">
                    <div class="blog__slide__img">
                        <img class="card-img rounded-0"
                             src="{{ asset('front/theme/sensive/img/blog/blog-slider/xblog-slide1.png.pagespeed.ic.qmnahmbyr_.jpg') }}"
                             alt="">
                    </div>
                ...
                <div class="card blog__slide text-center">
                    <div class="blog__slide__img">
                        <img class="card-img rounded-0"
                             src="{{ asset('front/theme/sensive/img/blog/blog-slider/xblog-slide2.png.pagespeed.ic.a3_mv2ssuh.jpg') }}"
                             alt="">
                    </div>
                    <div class="blog__slide__content">
                        <a class="blog__slide__label" href="#">Fashion</a>
                ...
                <div class="card blog__slide text-center">
                    <div class="blog__slide__img">
                        <img class="card-img rounded-0"
                             src="{{ asset('front/theme/sensive/img/blog/blog-slider/xblog-slide3.png.pagespeed.ic.xztepitv8g.jpg') }}"
                             alt="">
                    </div>
                    <div class="blog__slide__content">
                        <a class="blog__slide__label" href="#">Fashion</a>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('front/theme/sensive/img/blog/xblog1.png.pagespeed.ic.hj4vrdrbc3.jpg') }}"
                                 alt="">
                            <ul class="thumb-info">
                    ...
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('front/theme/sensive/img/blog/xblog2.png.pagespeed.ic.rzyvcre1zw.jpg') }}"
                                 alt="">
                            <ul class="thumb-info">
                                <li><a href="#"><i class="ti-user"></i>Admin</a></li>
                                <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
                    ...
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('front/theme/sensive/img/blog/xblog3.png.pagespeed.ic.po-not5lbn.jpg') }}"
                                 alt="">
                            <ul class="thumb-info">
                                <li><a href="#"><i class="ti-user"></i>Admin</a></li>
                                <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
                    ...
                    <div class="single-recent-blog-post">
                        <div class="thumb">
                            <img class="img-fluid" src="{{ asset('front/theme/sensive/img/blog/xblog4.png.pagespeed.ic.n5zypwt1tu.jpg') }}"
                                 alt="">
                            <ul class="thumb-info">
                                <li><a href="#"><i class="ti-user"></i>Admin</a></li>
                                <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
