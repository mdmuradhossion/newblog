            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Category Edit</h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fas fa-clipboard-list"></i> Category Edit</h3>
                        </div>

                        <div class="card-body">
                            <form id="submitForm" action="{{route('category.edit.action')}}" method="POST"   data-parsley-validate novalidate>
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 capitalize">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" data-parsley-trigger="change" required
                                                   placeholder="Enter category name" class="form-control" id="name" value="{{$category->name}}">
                                        ...
                                        <div class="form-group" id="reload">
                                            ...
                                            <select class="form-control capitalize" name="parent_id" data-parsley-trigger="change"
                                                    >
                                                @php echo getParentCategoryInOption($category->parent_id);@endphp
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="icon" data-parsley-trigger="change"
                                                   placeholder="Enter icon" class="form-control" id="icon" value="{{$category->icon}}">
                                        </div>
